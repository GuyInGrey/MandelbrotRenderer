...
namespace ComputeSharp.SwapChain.Backend
{
    ...
    internal unsafe static class Win32ApplicationRunner
    {
        ...
        public static int Run(Win32Application application)
        {
            ...
            var hInstance = FX.GetModuleHandleW(null);
            ...
            {
                (var application, var token) = ((Win32Application, CancellationToken))args!;
                ...
                case FX.WM_NCHITTEST:
                    {
                        ...
                        if (isAtTop)
                        {
                            if (isAtRight)
                            {
                                return FX.HTTOPRIGHT;
                            }

                            return isAtLeft ? FX.HTTOPLEFT : FX.HTTOP;
                        }
                        ...
                        if (isAtRight)
                        {
                            ...
                            return isAtBottom ? FX.HTBOTTOMRIGHT : FX.HTRIGHT;
                        }

                        if (isAtBottom)
                        {
                            return isAtRight ? FX.HTBOTTOMRIGHT : isAtLeft ? FX.HTBOTTOMLEFT : FX.HTBOTTOM;
                        }
                        ...
                        if (isAtLeft)
                        {
                            ...
                            return isAtBottom ? FX.HTBOTTOMLEFT : FX.HTLEFT;
                        }
